...
public class knightSight : MonoBehaviour
{
    ...
    private knightState stateRef;
    private knightState selfState;//reference to state machine
    ...
    void Start()
    {
        ...
        selfState = GetComponent<knightState>();
        bounds = GetComponent<postBoundary>();
        knight = GameObject.Find("Knight");
        stateRef = knight.GetComponent<knightState>();
